...
function Footer() {
    ...
    return (
        <footer className="px-4 divide-y dark:bg-gray-100 dark:text-gray-800">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <h1 className="self-center text-2xl font-semibold">Sakura Sushi</h1>
                    </a>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        <div className="uppercase dark:text-gray-900">Connect with us</div>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-600">© 2024 Sakura Sushi. All rights reserved.</div>
        </footer>
    )
}
