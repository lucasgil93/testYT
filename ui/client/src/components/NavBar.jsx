        ...
        <div className="container flex justify-between h-16 mx-auto">
          <div className="flex">
            <a
              ...
              className="flex items-center p-2 m-5"
            >
            ...
            <ul className="items-stretch hidden space-x-3 lg:flex">
              ...
              <li className="flex">
                <a
                  rel="noopener noreferrer"
                  href="/about"
                  className={`flex items-center px-4 -mb-1 border-b-2 hover:text-red-400 ${isActive(
                    "/about"
                  )}`}
                >
                  ABOUT
          ...
          <div className="items-center flex-shrink-0 hidden lg:flex">
            <button
              onClick={openModal}
              className="px-8 py-3 mx-2 font-semibold rounded dark:bg-red-600 dark:text-gray-50 hover:bg-red-900"
            >
              Log in
            </button>
            ...
            <ul className="space-y-3">
              <li className="flex">
                <a
                  rel="noopener noreferrer"
                  href="/about"
                  className={`flex items-center px-4 -mb-1 border-b-2 ${isActive(
                    "/about"
                  )}`}
                >
                  ABOUT
              ...
              <li className="flex">
                <button
                  onClick={openModal}
                  className="w-full px-8 py-3 font-semibold rounded my-2 dark:bg-red-600 dark:text-gray-50"
                >
                  Log in
                </button>
